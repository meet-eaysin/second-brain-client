...
import { Plus, Filter, Search, BarChart3, Download, Settings, Share } from 'lucide-react';
...
export function usePageHeader() {
    ...
    const createAction = (icon: ReactNode, label: string, onClick?: () => void, variant: 'default' | 'outline' = 'default') => (
    ...
    const createActions = {
        ...
        filter: (onClick?: () => void) => 
            createAction(<Filter className="h-4 w-4" />, 'Filter', onClick, 'outline'),
        
        analytics: (onClick?: () => void) => 
            createAction(<BarChart3 className="h-4 w-4" />, 'Analytics', onClick, 'outline'),
        
        download: (onClick?: () => void) => 
            createAction(<Download className="h-4 w-4" />, 'Download', onClick, 'outline'),
        
        settings: (onClick?: () => void) => 
            createAction(<Settings className="h-4 w-4" />, 'Settings', onClick, 'outline'),
