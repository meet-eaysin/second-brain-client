    ...
    if (allData) {
      ...
      goals?.data?.goals?.forEach((goal: any) => {
        nodeList.push({
          ...
          title: goal.title,
          status: goal.status,
          connections: [...(goal.projects || []), ...(goal.habits || [])],
          metadata: goal,
        });
      ...
      habits?.data?.habits?.forEach((habit: any) => {
        nodeList.push({
          ...
          connections: [...(habit.goal ? [habit.goal] : [])],
          metadata: habit,
        });
      });
              ...
              <div className="max-h-[400px] overflow-auto space-y-2">
                {filteredNodes.map((node) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`p-2 rounded ${getNodeColor(
                          node.type
                        )} text-white`}
                      >
          ...
          {selectedNode ? (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {selectedNode.type} • {selectedNode.connections.length}{" "}
                  connections
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                    ...
                    {selectedNode.connections
                      ...
                      .map((connectionId) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`p-1 rounded ${getNodeColor(
                                connectedNode.type
                              )} text-white`}
                            >
