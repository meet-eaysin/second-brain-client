        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ...
              Create powerful databases, manage information, and build your personal knowledge management system.
            </p>
          ...
          <div className="mt-16 relative">
            <div className="bg-white rounded-lg shadow-2xl border p-8 max-w-4xl mx-auto">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="ml-4 text-sm text-gray-500">second-brain.app</span>
              </div>
              <div className="bg-gray-50 rounded-lg p-6 text-left">
                <div className="flex items-center space-x-2 mb-4">
                  <Database className="h-5 w-5 text-blue-600" />
                  <span className="font-semibold">Project Tasks Database</span>
                  <Badge variant="outline" className="ml-auto">24 records</Badge>
                </div>
                <div className="grid grid-cols-4 gap-4 text-sm">
                  ...
                  <Badge className="bg-blue-100 text-blue-800 w-fit">In Progress</Badge>
                  <Badge className="bg-red-100 text-red-800 w-fit">High</Badge>
                  <div className="text-gray-600">Dec 15</div>

                  <div>Setup database</div>
                  <Badge className="bg-green-100 text-green-800 w-fit">Completed</Badge>
                  <Badge className="bg-yellow-100 text-yellow-800 w-fit">Medium</Badge>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful features designed to help you capture, organize, and connect your ideas seamlessly.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Create custom databases with rich property types, views, and relationships.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Find anything instantly with powerful search across all your content.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Create and manage databases like a pro with our comprehensive set of tools and features.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Property Types */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Rich Property Types</h3>
              <p className="text-gray-600 mb-8">
                Support for 11+ property types to structure your data exactly how you need it.
              </p>
            ...
            {/* Multiple Views */}
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Multiple Views</h3>
              <p className="text-gray-600 mb-8">
                Visualize your data in different ways with our flexible view system.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Classic spreadsheet-like interface</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Organize tasks by status or category</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Timeline and date-based visualization</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Visual card-based layout</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Advanced Features */}
          <div className="mt-20">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Advanced Database Operations</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Create complex filters with multiple conditions, operators, and property-specific rules.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Sort by multiple properties with custom priority and direction for perfect data organization.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Show, hide, reorder, and customize properties dynamically to focus on what matters.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you're managing projects, organizing research, or building a knowledge base,
              Second Brain adapts to your workflow.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Track tasks, deadlines, and team progress with customizable project databases.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Build your personal or team knowledge base with interconnected information.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Organize and analyze data with powerful filtering, sorting, and visualization tools.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Your digital knowledge hub for organizing, connecting, and discovering information.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Databases</a></li>
