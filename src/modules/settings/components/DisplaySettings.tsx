...
import { Monitor, Layout, Grid, Maximize, Eye, Zap } from 'lucide-react';
...
export const DisplaySettings: React.FC = () => {
    ...
    const contentWidthOptions = [
        ...
        { value: 'full', label: 'Full Width', description: 'Use full screen width' },
    ];
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <RadioGroup value={layoutDensity} onValueChange={setLayoutDensity} className="grid grid-cols-1 md:grid-cols-3 gap-4">
