...
export interface DocumentProperty {
    ...
    isVisible?: boolean;
    order?: number;
    config?: any; // Property-specific configuration
    [key: string]: any; // Allow additional fields
}
...
export interface DocumentView {
    ...
    config?: any; // View-specific configuration
    [key: string]: any; // Allow additional fields
}
...
export interface DocumentSchema<TRecord = any, TProperty = DocumentProperty, TView = DocumentView> {
    id: string;
    name: string;
    description?: string;
    icon?: string;
...
>({
    ...
    // Current items
    const [currentSchema, setCurrentSchema] = useState<TSchema | null>(initialSchema);
...
export const useDocumentView = () => {
    ...
    if (!documentViewContext) {
        throw new Error('useDocumentView has to be used within <DocumentViewProvider>');
    }
