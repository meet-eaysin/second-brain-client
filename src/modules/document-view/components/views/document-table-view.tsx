...
import type { DocumentProperty, DocumentView, DatabaseRecord } from '@/modules/document-view';
...
interface DocumentTableViewProps {
    ...
    apiFrozenConfig?: any; // API-provided frozen configuration
}
...
export function DocumentTableView({
    ...
    const frozenConfig = config?.frozenConfig || currentSchema?.config?.frozenConfig;
    ...
    const handleUpdateRecord = (recordId: string, propertyId: string, newValue: any) => {
        ...
        if (onRecordUpdate) {
            ...
            console.log('No update handler provided:', { recordId, propertyId, newValue });
        }
    };
