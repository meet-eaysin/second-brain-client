...
import type { DocumentView, DocumentProperty, DatabaseRecord } from '@/modules/document-view';
import {
...
export function DocumentGalleryView({
    ...
    const imageProperty = visibleProperties.find(p => p.type === 'URL') ||
