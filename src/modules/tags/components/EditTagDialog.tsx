...
import { useUpdateTag } from '../services/tagsQueries';
import type { TagWithUsage, UpdateTagRequest } from '@/types/tags.types';
...
export const EditTagDialog: React.FC<EditTagDialogProps> = ({
    ...
    const handleInputChange = (field: keyof UpdateTagRequest, value: string) => {
        setFormData(prev => ({
            ...prev,
            [field]: value,
        }));
