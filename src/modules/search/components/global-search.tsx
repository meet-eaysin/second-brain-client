...
import { searchApi, type GlobalSearchResult, type SearchFilters } from '../services/searchApi';
...
export function GlobalSearch({
    ...
    const handleResultClick = (result: any, type: 'database' | 'record' | 'user') => {
        setIsOpen(false);
                            ...
                            {results && (
                                <>
                                    {results.databases.length > 0 && (
                                        <CommandGroup heading={`Databases (${results.databases.length})`}>
                                    ...
                                    {results.records.length > 0 && (
                                        <CommandGroup heading={`Records (${results.records.length})`}>
