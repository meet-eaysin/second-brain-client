...
export const USER_KEYS = {
    ...
    stats: (params?: UserStatsQueryParams) => [...USER_KEYS.all, 'stats', params] as const,
};
...
export const useUpdateUser = () => {
    ...
    return useMutation({
        mutationFn: ({ id, data }: { id: string; data: UpdateUserByAdminRequest }) =>
...
export const useBulkUpdateUsers = () => {
    ...
    return useMutation({
        ...
        onSuccess: (result) => {
            queryClient.invalidateQueries({ queryKey: USER_KEYS.lists() });
            toast.success(`${result.updated} users updated successfully`);
