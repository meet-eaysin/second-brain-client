...
export function PropertyHeaderMenu({
    ...
    const handleChangeType = (newType: PropertyType) => {
        if (newType !== property.type) {
            ...
            toast.success(`Property type changed to ${PROPERTY_TYPES.find(t => t.value === newType)?.label}`);
        }
    };
            ...
            <Dialog open={isEditNameOpen} onOpenChange={setIsEditNameOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Change the name of this property. This will update the column header.
                        </DialogDescription>
                    </DialogHeader>
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            This will permanently remove the column and all its data from all records.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
