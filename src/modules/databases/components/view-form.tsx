                        ...
                        {properties.length === 0 ? (
                            <div className="border rounded-md p-6 text-center">
                                <div className="flex flex-col items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-muted-foreground">No Properties Available</h3>
                            ...
                            <>
                                    ...
                                    {(properties || []).map((property) => (
                                        <div key={property.id} className="flex items-center space-x-2 p-2 rounded hover:bg-background/80 transition-colors">
                                            <Checkbox
                                                ...
                                                checked={(formData.visibleProperties || []).includes(property.id)}
                                ...
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-muted-foreground">
                                        Selected: {(formData.visibleProperties || []).length} of {properties.length} properties
                                    </span>
