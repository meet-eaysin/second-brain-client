...
export const WORKSPACE_KEYS = {
    ...
    list: (params?: GetWorkspacesQuery) => [...WORKSPACE_KEYS.lists(), params] as const,
    ...
    permissions: (id: string) => [...WORKSPACE_KEYS.all, 'permissions', id] as const,
...
export const useGetWorkspaceStats = () => {
    return useQuery({
        ...
        queryFn: () => workspaceApi.getWorkspaceStats(),
...
export const useGetWorkspaceMembers = (workspaceId: string, params?: GetWorkspaceMembersQuery) => {
    return useQuery({
...
export const useDuplicateWorkspace = () => {
    ...
    return useMutation({
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.message || 'Failed to duplicate workspace');
        },
    });
};
...
export const useUpdateMemberRole = () => {
    ...
    return useMutation({
        mutationFn: ({ workspaceId, userId, data }: { 
            workspaceId: string; 
            userId: string; 
...
export const useTransferOwnership = () => {
    ...
    return useMutation({
        ...
        onSuccess: (_, { workspaceId }) => {
            // Invalidate workspace and members data
...
export const useBulkMemberOperation = () => {
    ...
    return useMutation({
        mutationFn: ({ workspaceId, data }: { workspaceId: string; data: BulkMemberOperationRequest }) =>
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.message || 'Failed to complete bulk operation');
        },
    });
};
